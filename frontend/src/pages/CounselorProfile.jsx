...
export default function CounselorProfile() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setAvatarFile(null);
            // setAvatarPreview(null); // Keep preview of new avatar? Or reset? Logic below uses user.avatar if preview is null, so resetting preview is okay if we update user state correctly. But user state url update might take time? No, local storage updated.
            // Better to keep preview null and let component render from user.avatar
    ...
    return (
        <div className="max-w-4xl mx-auto animate-fade-in relative">
                    ...
                    <div className="bg-white p-6 rounded-2xl w-full max-w-lg shadow-2xl animate-scale-up">
                        ...
                        <div className="relative w-full h-64 bg-gray-100 rounded-lg overflow-hidden mb-4">
                            <Cropper
                                ...
                                crop={crop}
                                zoom={zoom}
                                aspect={1} // Square crop for circle avatar
            ...
            <h1 className="text-2xl font-bold text-dark-900 mb-6">Profil Konselor</h1>
